...
const Research = () => {
  return (
    <div className="bg-white max-w-[1240px] h-[37vh] mx-auto flex flex-col sm:flex-row justify-start items-center pl-5" id='research'>
      ...
      <div className="flex flex-col justify-center items-start text-left p-4 animate-fadeIn max-w-[640px]">
        <h1 className="text-red-600 text-3xl font-bold mb-4 drop-shadow-lg">
          ...
          <span className="inline-block">Research Festival</span>
        </h1>
